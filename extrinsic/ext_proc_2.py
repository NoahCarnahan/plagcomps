...
class Fingerprint(Base):
    __tablename__ = "new_fingerprint"
    id = Column(Integer, Sequence("new_fingerprint_id_seq"), primary_key=True)
...
class _FpSubList(Base):
    __tablename__ = "fp_sub_list"
    id = Column(Integer, Sequence("fp_sub_list_id_seq"), primary_key = True)
    fingerprint_id = Column(Integer, ForeignKey("new_fingerprint.id"))
